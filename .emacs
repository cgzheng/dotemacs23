...
;; Time-stamp: <2010-11-22 17:46:49 Monday by work>
...
;;春光：为解决deamon模式下的输入与显示乱码
(global-set-key (kbd "C-x / u") 'set-default-coding-system-utf8)
(global-set-key (kbd "C-x / g") 'set-default-coding-system-gb18030)
...
;; 春光：在Emacs里面使用shell, 试用了eshell，但不好用，所以改用shell了。
(require 'multi-shell-settings)
